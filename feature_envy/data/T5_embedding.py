...
df = pd.read_csv('../data/feature_envy.csv')
# print(df.head())
...
embedding_small_path = '../T5/df_fe_embeded_by_line_small.pkl'
embed_line_by_line(df, model_small, embedding_small_path)

embedding_small_path = '../T5/df_fe_embeded_small.pkl'
...
embedding_base_path = '../T5/df_fe_embeded_by_line_base.pkl'
embed_line_by_line(df, model_base, embedding_base_path)

embedding_base_path = '../T5/df_fe_embeded_base.pkl'
